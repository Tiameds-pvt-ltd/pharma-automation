...
public class BillItemServiceImpl implements BillItemService {
    ...
    @Override
    public List<ItemPatientBillDto> getItemPatientBillDetails(UUID itemId, Long pharmacyId, String monthYear, String dateRange, User user) {
        User persistentUser = userRepository.findByIdFetchPharmacies(user.getId())
                .orElseThrow(() -> new RuntimeException("User not found"));
        ...
        return billItemRepository.findItemPatientBillDetails(
                itemId,
                pharmacyId,
                startDate,
                endDate
