...
public class BillMapper {
    ...
    public BillDto toDto(BillEntity billEntity) {
     BillDto billDto = new BillDto();
        ...
        billDto.setBalanceDue(billEntity.getBalanceDue());
        billDto.setRoundedOff(billEntity.getRoundedOff());
    ...
    public BillItemDto toDto(BillItemEntity billItemEntity) {
        ...
        billItemDto.setSalePrice(billItemEntity.getSalePrice());
    ...
    public BillPaymentDto toDtoPayment(BillPaymentEntity billPaymentEntity) {
        ...
        billPaymentDto.setPaymentId(billPaymentEntity.getPaymentId());
        billPaymentDto.setPaymentDate(billPaymentEntity.getPaymentDate());
        billPaymentDto.setPaymentType(billPaymentEntity.getPaymentType());
        billPaymentDto.setPaymentAmount(billPaymentEntity.getPaymentAmount());
        billPaymentDto.setReturnAmount(billPaymentEntity.getReturnAmount());
    ...
    public BillEntity toEntity(BillDto billDto) {
        ...
        billEntity.setBalanceDue(billDto.getBalanceDue());
        billEntity.setRoundedOff(billDto.getRoundedOff());
    ...
    public BillItemEntity toEntity(BillItemDto billItemDto) {
        ...
        billItemEntity.setSalePrice(billItemDto.getSalePrice());
    ...
    public BillPaymentEntity toEntityPayment(BillPaymentDto billPaymentDto) {
        ...
        billPaymentEntity.setPaymentId(billPaymentDto.getPaymentId());
        billPaymentEntity.setPaymentDate(billPaymentDto.getPaymentDate());
        billPaymentEntity.setPaymentType(billPaymentDto.getPaymentType());
        billPaymentEntity.setPaymentAmount(billPaymentDto.getPaymentAmount());
        billPaymentEntity.setReturnAmount(billPaymentDto.getReturnAmount());
